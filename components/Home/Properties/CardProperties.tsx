...
const CardProperties = ({item}:Props) => {
    return (
        <div className='bg-white overflow-hidden group rounded-lg cursor-pointer shadow-lg '>
            <div className='relative'>
              <Image src={item.imageUrl} alt={item.propertyName} width={300} height={300} className='w-full object-cover group-hover:scale-110 transition-all duration-300'/>
            ...
            <div className='p-5'>
                <h1 className='mt-4 group-hover:underline text-gray-900 font-bold text-lg'>{item.propertyName}</h1>
                <p className='text-sm text-gray-500 pt-3'>{item.location}</p>
